...
export const IconHomeLine = () => wrap(<><path d="M3.5 10.8 12 3.6l8.5 7.2" /><path d="M5.6 12.4v7.2h12.8v-7.2" /><path d="M9.9 19.6v-4.4h4.2v4.4" /></>);
...
export const IconRoomsLine = () => wrap(<><circle cx="9" cy="8.4" r="3.2" /><circle cx="16.6" cy="9.6" r="2.4" /><path d="M3.6 19.4c0-3 2.4-5 5.4-5s5.4 2 5.4 5" /><path d="M16.4 14.6c2.4.2 4 2.1 4 4.8" /></>);
...
export const IconPlayLine = () => wrap(<><circle cx="12" cy="12" r="8.6" /><path d="M10.2 8.6 L16 12 L10.2 15.4 Z" /></>);
export const IconRanksLine = () => wrap(<><path d="M5 20.4V13" /><path d="M12 20.4V6.2" /><path d="M19 20.4v-5.6" /><path d="M3.2 20.4h17.6" /></>);
