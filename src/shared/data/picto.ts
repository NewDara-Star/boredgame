...
export interface PictoSeed {
  ...
  items: RebusItem[];
  answer: string;
  /** Other phrasings a player might reasonably type for the same picture.
      The picture is the question, so anything the picture licenses belongs
      here — dropped articles, the literal reading, regional variants.
      check-answers.mts proves no entry collides with another puzzle. */
  accept?: string[];
  alt_hint: string;
  char_hint: string;
...
export const PICTO_SEED: PictoSeed[] = [
  ...
  { slug: "youre-under-arrest", items: [t("ARREST", 50, 34, { size: 14 }), t("YOU'RE", 50, 66, { size: 14 })],
    ...
    accept: ["youre under arrest", "under arrest"], alt_hint: "The bottom word is beneath the top one — and it's about you", char_hint: "Something a police officer says", difficulty: "medium", category: "Idioms" },

  { slug: "under-the-weather", items: [t("WEATHER", 50, 33, { size: 13 }), t("FEELING", 50, 67, { size: 13 })],
    answer: "under the weather",
    accept: ["feeling under the weather", "feeling under weather", "under weather"], alt_hint: "How you feel is sitting below the sky", char_hint: "3 words · starts with U", difficulty: "medium", category: "Idioms" },

  { slug: "life-after-death", items: [t("DEATH", 27, 50, { size: 12, w: 37 }), t("LIFE", 73, 50, { size: 12, w: 30 })],
    answer: "life after death",
    accept: ["afterlife", "the afterlife"], alt_hint: "One word comes after the other, left to right", char_hint: "3 words · middle word is 5 letters", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "tricycle", items: [t("CYCLE", 18, 50, { size: 9, w: 28 }), t("CYCLE", 50, 50, { size: 9, w: 28 }), t("CYCLE", 82, 50, { size: 9, w: 28 })],
    answer: "tricycle",
    accept: ["3 cycle", "three cycle"], alt_hint: "Count them", char_hint: "1 word · 8 letters", difficulty: "easy", category: "Everyday" },

  { slug: "second-chance", items: [t("CHANCE", 26, 50, { size: 11, w: 41 }), t("CHANCE", 74, 50, { size: 11, w: 41 })],
    answer: "second chance",
    accept: ["2nd chance", "a second chance"], alt_hint: "Two of the same thing — which one matters?", char_hint: "2 words · 6 then 6", difficulty: "easy", category: "Idioms" },

  { slug: "forearm", items: [t("ARM", 14, 50, { size: 11, w: 20 }), t("ARM", 38, 50, { size: 11, w: 20 }), t("ARM", 62, 50, { size: 11, w: 20 }), t("ARM", 86, 50, { size: 11, w: 20 })],
    answer: "forearm",
    accept: ["four arm", "4 arm"], alt_hint: "Count them, then say it out loud", char_hint: "1 word · part of the body", difficulty: "medium", category: "Everyday" },
  ...
  { slug: "forget-it", items: [t("GET IT", 27, 32, { size: 10, w: 37 }), t("GET IT", 73, 32, { size: 10, w: 37 }), t("GET IT", 27, 68, { size: 10, w: 37 }), t("GET IT", 73, 68, { size: 10, w: 37 })],
    answer: "forget it",
    accept: ["four get it", "4 get it"], alt_hint: "Four of them. Say the number first", char_hint: "2 words · dismissive", difficulty: "medium", category: "Idioms" },

  { slug: "backward-glance", items: [t("ECNALG", 50, 50, { size: 16 })],
    answer: "backward glance",
    accept: ["glance backward", "backwards glance", "a backward glance"], alt_hint: "Read it the other way", char_hint: "2 words · second word is 6 letters", difficulty: "medium", category: "Idioms" },

  { slug: "looking-back", items: [t("GNIKOOL", 50, 50, { size: 14 })],
    answer: "looking back",
    accept: ["look back", "looking backward", "looking backwards"], alt_hint: "The word has turned around", char_hint: "2 words · 7 then 4", difficulty: "medium", category: "Idioms" },

  { slug: "unfinished-symphony", items: [t("SYMPHON", 50, 50, { size: 15 })],
    answer: "unfinished symphony",
    accept: ["the unfinished symphony", "incomplete symphony"], alt_hint: "Something is missing from the end", char_hint: "2 words · classical music", difficulty: "hard", category: "Music" },

  { slug: "history-repeats", items: [t("HISTORY", 50, 34, { size: 13 }), t("HISTORY", 50, 66, { size: 13 })],
    answer: "history repeats itself",
    accept: ["history repeats", "history repeating itself", "history repeating"], alt_hint: "It happened, and then it happened again", char_hint: "3 words · starts with H", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "man-in-the-moon", items: [t("MO", 27, 50, { size: 14, w: 18 }), t("MAN", 50, 50, { size: 14, w: 26 }), t("ON", 73, 50, { size: 14, w: 18 })],
    ...
    accept: ["the man in the moon", "man in moon"], alt_hint: "One word is sitting inside another", char_hint: "4 words · look up at night", difficulty: "hard", category: "Places" },

  { slug: "one-after-another", items: [t("ONE", 20, 50, { size: 13, w: 24 }), t("ANOTHER", 68, 50, { size: 11, w: 48 })],
    answer: "one after another",
    accept: ["one another", "one after the other"], alt_hint: "Left to right, and the position is the clue", char_hint: "3 words · middle word is 5 letters", difficulty: "medium", category: "Idioms" },

  { slug: "small-world", items: [t("WORLD", 50, 50, { size: 6 })],
    answer: "small world",
    accept: ["its a small world", "it is a small world"], alt_hint: "The size of the word is the point", char_hint: "2 words · said when you bump into someone", difficulty: "easy", category: "Idioms" },
  ...
  { slug: "travel-overseas", items: [t("TRAVEL", 50, 33, { size: 13, w: 48 }), t("C C C C", 50, 67, { size: 13, w: 56 })],
    ...
    accept: ["overseas travel", "travelling overseas", "traveling overseas"], alt_hint: "The letters below sound like water", char_hint: "2 words · about going abroad", difficulty: "hard", category: "Places" },

  { slug: "seven-seas", items: [t("C C C C C C C", 50, 50, { size: 11, w: 88 })],
    answer: "seven seas",
    accept: ["7 seas", "the seven seas", "sail the seven seas"], alt_hint: "Count the letters, then say the letter out loud", char_hint: "2 words · 5 then 4", difficulty: "medium", category: "Places" },

  { slug: "three-degrees-below-zero", items: [t("0", 50, 30, { size: 24 }), t("B.A.  M.A.  PhD", 50, 68, { size: 8, w: 74 })],
    answer: "three degrees below zero",
    accept: ["3 degrees below zero", "three degrees under zero"], alt_hint: "Qualifications underneath a number", char_hint: "4 words · about temperature", difficulty: "hard", category: "Everyday" },
  ...
  { slug: "scrambled-eggs", items: [t("G", 32, 44, { size: 18, rotate: -14 }), t("E", 46, 56, { size: 18, rotate: 8 }), t("S", 60, 43, { size: 18, rotate: -6 }), t("G", 73, 52, { size: 18, rotate: 15 })],
    ...
    accept: ["scrambled egg"], alt_hint: "The word is scattered", char_hint: "2 words · 5th letter: m, 12th letter: g", difficulty: "hard", category: "Food" },

  { slug: "ice-cube", items: [t("ICE", 47, 50, { size: 26, font: "serif", sup: "3" })],
    answer: "ice cube",
    accept: ["ice cubed", "ice cubes"], alt_hint: "A small number is doing the work", char_hint: "2 words · 3 then 4", difficulty: "medium", category: "Food" },

  { slug: "i-understand", items: [t("I", 50, 32, { size: 18 }), t("STAND", 50, 66, { size: 15 })],
    answer: "i understand",
    accept: ["understand"], alt_hint: "One letter is above one word", char_hint: "2 words · means 'I get it'", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "six-feet-underground", items: [t("GROUND", 50, 28, { size: 13 }), t("FEET FEET FEET", 50, 58, { size: 8 }), t("FEET FEET FEET", 50, 74, { size: 8 })],
    ...
    accept: ["six feet under", "6 feet under", "6 feet underground"], alt_hint: "Count what is below the ground", char_hint: "3 words · not a cheerful one", difficulty: "hard", category: "Idioms" },

  { slug: "broken-promise", items: [t("PROMISE", 50, 50, { size: 15, strike: true })],
    answer: "broken promise",
    accept: ["a broken promise", "broken promises", "break a promise"], alt_hint: "A line has been drawn through it", char_hint: "2 words · 6 then 7", difficulty: "easy", category: "Idioms" },

  { slug: "broken-heart", items: [t("HEART", 50, 50, { size: 18, strike: true })],
    answer: "broken heart",
    accept: ["a broken heart", "heartbroken"], alt_hint: "A line has been drawn through it", char_hint: "2 words · 6 then 5", difficulty: "easy", category: "Idioms" },

  { slug: "paradise", items: [t("DICE", 26, 50, { size: 12, w: 30 }), t("DICE", 74, 50, { size: 12, w: 30 })],
    answer: "paradise",
    accept: ["pair of dice"], alt_hint: "Two of them — say what a set of two is called", char_hint: "1 word · 8 letters, somewhere lovely", difficulty: "hard", category: "Places" },

  { slug: "excuse-me", items: [t("X", 17, 50, { size: 16, w: 11 }), t("Q Q", 47, 50, { size: 14, w: 22 }), t("ME", 82, 50, { size: 14, w: 19 })],
    answer: "excuse me",
    accept: ["x q q me", "x cues me", "pardon me"], alt_hint: "Say each letter out loud rather than reading it — two Qs are two cues", char_hint: "2 words · polite interruption", difficulty: "hard", category: "Everyday" },


  { slug: "just-under-the-wire", items: [t("WIRE", 50, 33, { size: 15 }), t("JUST", 50, 67, { size: 15 })],
    answer: "just under the wire",
    accept: ["under the wire", "just under wire"], alt_hint: "Barely made it", char_hint: "4 words · about being on time", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "reading-between-the-lines", items: [
    ...
    accept: ["read between the lines", "reading between lines"], alt_hint: "Where is the word sitting?", char_hint: "4 words · about hidden meaning", difficulty: "medium", category: "Idioms" },

  { slug: "split-second", items: [t("SEC", 27, 50, { size: 14, w: 26 }), t("OND", 73, 50, { size: 14, w: 26 })],
    answer: "split second",
    accept: ["a split second", "in a split second"], alt_hint: "The word itself has been divided", char_hint: "2 words · a very short time", difficulty: "medium", category: "Everyday" },
  ...
  { slug: "misunderstanding", items: [t("STANDING", 50, 34, { size: 12, w: 60 }), t("MIS", 50, 66, { size: 14, w: 26 })],
    ...
    accept: ["a misunderstanding"], alt_hint: "One word sits beneath the other", char_hint: "1 word · what a row usually is", difficulty: "medium", category: "Idioms" },

  { slug: "water-under-the-bridge", items: [t("BRIDGE", 50, 33, { size: 14, w: 52 }), t("WATER", 50, 67, { size: 14, w: 44 })],
    answer: "water under the bridge",
    accept: ["water under bridge", "its water under the bridge"], alt_hint: "Read the lower word's position", char_hint: "4 words · about letting things go", difficulty: "easy", category: "Idioms" },

  { slug: "all-over-the-world", items: [t("ALL", 50, 34, { size: 15, w: 28 }), t("WORLD", 50, 66, { size: 14, w: 44 })],
    answer: "all over the world",
    accept: ["all over world", "the whole world over"], alt_hint: "The top word is sitting on the bottom one", char_hint: "4 words · everywhere", difficulty: "easy", category: "Places" },
  ...
  { slug: "play-on-words", items: [t("PLAY", 50, 34, { size: 15, w: 37 }), t("WORDS", 50, 66, { size: 14, w: 44 })],
    ...
    accept: ["a play on words", "wordplay"], alt_hint: "The top word rests on the bottom one", char_hint: "3 words · what this whole game is", difficulty: "easy", category: "Idioms" },

  { slug: "eggs-over-easy", items: [t("EGGS", 50, 34, { size: 15, w: 37 }), t("EASY", 50, 66, { size: 15, w: 37 })],
    answer: "eggs over easy",
    accept: ["over easy eggs", "over easy", "egg over easy"], alt_hint: "Position tells you the middle word", char_hint: "3 words · a breakfast order", difficulty: "easy", category: "Food" },
  ...
  { slug: "walking-on-air", items: [t("WALKING", 50, 34, { size: 12, w: 52 }), t("AIR", 50, 66, { size: 15, w: 28 })],
    ...
    accept: ["walk on air", "walking on the air"], alt_hint: "The top word rests on the bottom one", char_hint: "3 words · how delight feels", difficulty: "easy", category: "Idioms" },

  { slug: "banana-split", items: [t("BAN", 30, 50, { size: 15, w: 28 }), t("ANA", 70, 50, { size: 15, w: 28 })],
    answer: "banana split",
    accept: ["a banana split", "split banana"], alt_hint: "One word has been divided in two", char_hint: "2 words · a dessert", difficulty: "medium", category: "Food" },
  ...
  { slug: "one-in-a-million", items: [t("MIL", 22, 50, { size: 15, w: 28 }), t("1", 50, 50, { size: 20, w: 8 }), t("ION", 78, 50, { size: 15, w: 28 })],
    ...
    accept: ["1 in a million", "one in million"], alt_hint: "A number has been placed inside a word", char_hint: "4 words · high praise", difficulty: "hard", category: "Idioms" },
  ...
  { slug: "face-to-face", items: [t("FACE", 28, 50, { size: 13, w: 32 }), t("FACE", 72, 50, { size: 13, w: 32 })],
    answer: "face to face",
    accept: ["face 2 face"], alt_hint: "Two of the same, side by side", char_hint: "3 words · in person", difficulty: "easy", category: "Idioms" },

  { slug: "side-by-side", items: [t("SIDE", 28, 50, { size: 13, w: 32 }), t("SIDE", 72, 50, { size: 13, w: 32 })],
    answer: "side by side",
    accept: ["side to side"], alt_hint: "Two of the same, next to each other", char_hint: "3 words · the layout is the clue", difficulty: "easy", category: "Idioms" },

  { slug: "forgive", items: [t("GIVE", 14, 50, { size: 9, w: 22 }), t("GIVE", 38, 50, { size: 9, w: 22 }), t("GIVE", 62, 50, { size: 9, w: 22 }), t("GIVE", 86, 50, { size: 9, w: 22 })],
    answer: "forgive",
    accept: ["four give", "4 give", "forgiveness"], alt_hint: "Count them, then say the number out loud", char_hint: "1 word · what you do after an apology", difficulty: "medium", category: "Idioms" },

  { slug: "about-face", items: [t("ECAF", 50, 50, { size: 17, w: 42 })],
    answer: "about face",
    accept: ["face about", "an about face", "about turn"], alt_hint: "The word has been turned around", char_hint: "2 words · a sharp reversal", difficulty: "medium", category: "Idioms" },

  { slug: "broken-record", items: [t("RECORD", 50, 50, { size: 15, w: 56, strike: true })],
    answer: "broken record",
    accept: ["a broken record", "like a broken record"], alt_hint: "A line has been drawn through it", char_hint: "2 words · someone who repeats themselves", difficulty: "easy", category: "Music" },
  ...
  { slug: "turn-around", items: [t("AROUND", 50, 50, { size: 15, w: 56, rotate: 180 })],
    answer: "turn around",
    accept: ["turnabout", "turn about"], alt_hint: "The word is doing what it says", char_hint: "2 words · 4 then 6", difficulty: "easy", category: "Everyday" },

  { slug: "water-h-to-o", items: [t("H  I J K L M N  O", 50, 50, { size: 11, w: 86 })],
    answer: "water",
    accept: ["h2o", "h to o", "h two o"], alt_hint: "Read the first letter, then where the run ends", char_hint: "1 word · H to O", difficulty: "hard", category: "Food" },

  { slug: "i-see-you", items: [t("I", 32.5, 50, { size: 17, w: 5.1 }), t("C", 47.3, 50, { size: 17, w: 10.5 }), t("U", 64.8, 50, { size: 17, w: 10.5 })],
    answer: "i see you",
    accept: ["icu", "eye see you"], alt_hint: "Say each letter out loud instead of reading it", char_hint: "3 words", difficulty: "easy", category: "Everyday" },

  { slug: "before", items: [t("B", 41.2, 50, { size: 17, w: 10.5 }), t("4", 58.8, 50, { size: 17, w: 10.5 })],
    answer: "before",
    accept: ["b4", "b four", "bee four"], alt_hint: "A letter and a number, both said aloud", char_hint: "1 word · 6 letters", difficulty: "easy", category: "Everyday" },

  { slug: "cucumber", items: [t("Q", 12.7, 50, { size: 17, w: 10.5 }), t("CUMBER", 58.8, 50, { size: 17, w: 67.7 })],
    answer: "cucumber",
    accept: ["q cumber", "queue cumber"], alt_hint: "The first letter is doing a syllable's work", char_hint: "1 word · a salad vegetable", difficulty: "medium", category: "Food" },

  { slug: "excel", items: [t("X", 41.8, 50, { size: 17, w: 10.5 }), t("L", 58.8, 50, { size: 17, w: 9.4 })],
    answer: "excel",
    accept: ["xl", "ex el"], alt_hint: "Two letters, said out loud", char_hint: "1 word · to do very well", difficulty: "medium", category: "Everyday" },

  { slug: "envy", items: [t("N", 41.2, 50, { size: 17, w: 10.5 }), t("V", 58.8, 50, { size: 17, w: 10.5 })],
    answer: "envy",
    accept: ["nv", "en vee"], alt_hint: "Two letters, said out loud", char_hint: "1 word · a deadly sin", difficulty: "medium", category: "Everyday" },

  { slug: "empty", items: [t("M", 41.6, 50, { size: 17, w: 15 }), t("T", 61, 50, { size: 17, w: 9.9 })],
    answer: "empty",
    accept: ["mt", "em tee"], alt_hint: "Two letters, said out loud", char_hint: "1 word · the opposite of full", difficulty: "medium", category: "Everyday" },

  { slug: "enemy", items: [t("N", 30.3, 50, { size: 17, w: 10.5 }), t("M", 50, 50, { size: 17, w: 15 }), t("E", 69.7, 50, { size: 17, w: 10.5 })],
    answer: "enemy",
    accept: ["nme", "en em ee"], alt_hint: "Three letters, said out loud", char_hint: "1 word · not a friend", difficulty: "medium", category: "Everyday" },

  { slug: "energy", items: [t("N", 32.5, 50, { size: 17, w: 10.5 }), t("R", 50, 50, { size: 17, w: 10.5 }), t("G", 67.5, 50, { size: 17, w: 10.5 })],
    answer: "energy",
    accept: ["nrg", "en ar gee"], alt_hint: "Three letters, said out loud", char_hint: "1 word · what you run on", difficulty: "medium", category: "Science" },

  { slug: "tennis", items: [t("10", 41.2, 50, { size: 17, w: 17.3 }), t("S", 62.2, 50, { size: 17, w: 10.5 })],
    answer: "tennis",
    accept: ["10 is", "ten is", "ten s", "tenis"], alt_hint: "Say the number, then the letter", char_hint: "1 word · a racket sport", difficulty: "medium", category: "Sport" },

  { slug: "wonderful", items: [t("1", 15.5, 50, { size: 17, w: 6.8 }), t("DERFUL", 56.9, 50, { size: 17, w: 62.1 })],
    answer: "wonderful",
    accept: ["1derful", "one derful"], alt_hint: "The number replaces a syllable", char_hint: "1 word · 9 letters", difficulty: "medium", category: "Everyday" },

  { slug: "together", items: [t("2", 15.2, 50, { size: 17, w: 10.5 }), t("GETHER", 58.8, 50, { size: 17, w: 62.6 })],
    answer: "together",
    accept: ["2gether", "two gether"], alt_hint: "The number replaces a syllable", char_hint: "1 word · 8 letters", difficulty: "easy", category: "Everyday" },

  { slug: "tooth", items: [t("2", 36.3, 50, { size: 17, w: 10.5 }), t("TH", 58.8, 50, { size: 17, w: 20.4 })],
    answer: "tooth",
    accept: ["2th", "two th", "2 th"], alt_hint: "Say the number, then the letters", char_hint: "1 word · you have about 32", difficulty: "medium", category: "Everyday" },

  { slug: "great", items: [t("GR", 41.2, 50, { size: 17, w: 21.1 }), t("8", 64, 50, { size: 17, w: 10.5 })],
    answer: "great",
    accept: ["gr8", "gr eight", "grate"], alt_hint: "The number is the end of the word", char_hint: "1 word · 5 letters", difficulty: "easy", category: "Everyday" },
  ...
  { slug: "pig-in-a-blanket", items: [t("BLAN", 20.9, 50, { size: 13.2, w: 31.7 }), t("PIG", 53.9, 50, { size: 13.2, w: 20.3 }), t("KET", 83, 50, { size: 13.2, w: 24 })],
    ...
    accept: ["pig in blanket", "pigs in blankets", "pig in the blanket"], alt_hint: "One word has been placed inside another", char_hint: "4 words · something wrapped", difficulty: "medium", category: "Food" },

  { slug: "cat-out-of-the-bag", items: [t("CAT", 50, 24, { size: 14, w: 25 }), t("B", 32, 66, { size: 16, w: 10 }), t("AG", 66, 66, { size: 16, w: 20 })],
    answer: "cat out of the bag",
    accept: ["cat out of the bag", "the cat out of the bag", "let the cat out the bag", "cat is out of the bag", "let the cat out of the bag"], alt_hint: "One word has climbed out of the other", char_hint: "5 words · a secret, no longer a secret", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "fly-in-the-ointment", items: [t("OINT", 17.2, 50, { size: 11.5, w: 24.4 }), t("FLY", 46.7, 50, { size: 11.5, w: 20.6 }), t("MENT", 79.5, 50, { size: 11.5, w: 31 })],
    ...
    accept: ["fly in ointment", "a fly in the ointment"], alt_hint: "One word has been placed inside another", char_hint: "4 words · the one thing spoiling it", difficulty: "hard", category: "Idioms" },
  ...
  { slug: "ace-in-the-hole", items: [t("H", 12, 50, { size: 17, w: 10.5 }), t("ACE", 40.1, 50, { size: 17, w: 31.6 }), t("OLE", 78.1, 50, { size: 17, w: 30.4 })],
    ...
    accept: ["ace in hole", "an ace in the hole"], alt_hint: "One word has been placed inside another", char_hint: "4 words · a hidden advantage", difficulty: "medium", category: "Idioms" },

  { slug: "bee-in-your-bonnet", items: [t("BON", 17.8, 50, { size: 13.7, w: 25.5 }), t("BEE", 50.3, 50, { size: 13.7, w: 25.5 }), t("NET", 82.5, 50, { size: 13.7, w: 25 })],
    answer: "bee in your bonnet",
    accept: ["bee in bonnet", "a bee in your bonnet", "bee in the bonnet", "bee in his bonnet", "bee in her bonnet"], alt_hint: "One word has been placed inside another", char_hint: "4 words · an obsession", difficulty: "hard", category: "Idioms" },
  ...
  { slug: "stitch-in-time", items: [t("TI", 10.9, 50, { size: 13.3, w: 11.7 }), t("STITCH", 45.9, 50, { size: 13.3, w: 44.3 }), t("ME", 85, 50, { size: 13.3, w: 20 })],
    ...
    accept: ["a stitch in time saves nine", "stitch in time"], alt_hint: "One word has been placed inside another", char_hint: "4 words · saves nine", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "storm-in-a-teacup", items: [t("TEA", 14.9, 50, { size: 10.9, w: 19.8 }), t("STORM", 49.8, 50, { size: 10.9, w: 36 }), t("CUP", 84.9, 50, { size: 10.9, w: 20.2 })],
    ...
    accept: ["tempest in a teapot", "storm in teacup", "storm in a tea cup"], alt_hint: "One word has been placed inside another", char_hint: "4 words · a fuss over nothing", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "head-in-the-clouds", items: [t("CLO", 16.1, 50, { size: 12.4, w: 22.2 }), t("HEAD", 49.6, 50, { size: 12.4, w: 30.7 }), t("UDS", 83.5, 50, { size: 12.4, w: 23.1 })],
    ...
    accept: ["head in clouds", "head in the cloud"], alt_hint: "One word has been placed inside another", char_hint: "4 words · not paying attention", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "foot-in-mouth", items: [t("MO", 14.9, 50, { size: 13.2, w: 19.8 }), t("FOOT", 47.9, 50, { size: 13.2, w: 32.2 }), t("UTH", 83, 50, { size: 13.2, w: 24 })],
    ...
    accept: ["foot in your mouth", "foot in the mouth", "put your foot in your mouth", "foot in mouth disease"], alt_hint: "One word has been placed inside another", char_hint: "3 words · said the wrong thing", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "fading-memory", items: [t("MEMORY", 50, 50, { size: 20, w: 84.8, opacity: 0.25 })],
    answer: "fading memory",
    accept: ["faded memory", "memory fading", "a fading memory", "fading memories"], alt_hint: "The word is barely there", char_hint: "2 words · what you can't quite recall", difficulty: "medium", category: "Everyday" },

  { slug: "fade-away", items: [t("AWAY", 50, 50, { size: 20, w: 54.8, opacity: 0.25 })],
    answer: "fade away",
    accept: ["fading away", "faded away", "fades away"], alt_hint: "The word is barely there", char_hint: "2 words · 4 then 4", difficulty: "medium", category: "Music" },

  { slug: "noel", items: [t("J K M N O", 50, 50, { size: 16, w: 69.4 })],
    answer: "noel",
    accept: ["no l", "first noel", "the first noel"], alt_hint: "Read the letters in order — one is missing", char_hint: "1 word · a Christmas carol", difficulty: "hard", category: "Music" },
  ...
  { slug: "above-board", items: [t("BOARD", 50, 30, { size: 14, w: 43 }), t("————————", 50, 58, { size: 11 })],
    answer: "above board",
    accept: ["all above board", "its all above board"], alt_hint: "Where the word sits is the clue", char_hint: "2 words · honest and open", difficulty: "medium", category: "Idioms" },
  ...
  { slug: "big-deal", items: [t("DEAL", 50, 50, { size: 22, w: 53 })],
    answer: "big deal",
    accept: ["a big deal"], alt_hint: "The size of the word is the point", char_hint: "2 words · 3 then 4", difficulty: "easy", category: "Everyday" },

  { slug: "small-print", items: [t("PRINT", 50, 50, { size: 6, w: 16.4 })],
    answer: "small print",
    accept: ["the small print", "fine print", "read the small print"], alt_hint: "The size of the word is the point", char_hint: "2 words · where the catch hides", difficulty: "easy", category: "Design" },

  { slug: "big-bang", items: [t("BANG", 50, 50, { size: 22, w: 54.6 })],
    answer: "big bang",
    accept: ["the big bang", "big bang theory"], alt_hint: "The size of the word is the point", char_hint: "2 words · how it all started", difficulty: "easy", category: "Science" },

  { slug: "square-feet", items: [t("FEET", 50, 50, { size: 20, w: 48.8, sup: "2" })],
    answer: "square feet",
    accept: ["feet squared", "square foot", "sq ft"], alt_hint: "A small number is doing the work", char_hint: "2 words · a unit of area", difficulty: "medium", category: "Maths" },

  { slug: "square-meal", items: [t("MEAL", 50, 50, { size: 20, w: 53.4, sup: "2" })],
    answer: "square meal",
    accept: ["a square meal", "meal squared", "three square meals"], alt_hint: "A small number is doing the work", char_hint: "2 words · a proper dinner", difficulty: "medium", category: "Food" },

  { slug: "chip-on-your-shoulder", items: [t("CHIP", 50, 34, { size: 15, w: 32.4 }), t("SHOULDER", 50, 66, { size: 15, w: 73.4 })],
    answer: "chip on your shoulder",
    accept: ["chip on shoulder", "chip on his shoulder", "chip on her shoulder", "a chip on your shoulder", "chip on the shoulder"], alt_hint: "The top word rests on the bottom one", char_hint: "4 words · a grudge", difficulty: "medium", category: "Idioms" },

  { slug: "cards-on-the-table", items: [t("CARDS", 50, 34, { size: 15, w: 46.5 }), t("TABLE", 50, 66, { size: 15, w: 44.9 })],
    answer: "cards on the table",
    accept: ["cards on table", "put your cards on the table", "lay your cards on the table"], alt_hint: "The top word rests on the bottom one", char_hint: "4 words · being open", difficulty: "easy", category: "Idioms" },
